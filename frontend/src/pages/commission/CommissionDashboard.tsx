//frontend/src/pages/commission/CommissionDashboard.tsx
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <p>Loading Commission Dashboard...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Welcome, <strong>{user?.name || 'Commission Member'}</strong>! Overview of national AIMS compliance.
            </p>
          </div>
        ...
        <footer className="mt-12 pt-4 border-t border-gray-200 text-xs text-gray-500">
          Commission Dashboard - AIMS National Compliance Monitoring • Last updated: {new Date().toLocaleString()}
        </footer>
